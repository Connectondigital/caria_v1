  ...
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 pb-4">
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        <p className="text-lg font-bold text-white">Caria Estates</p>
        <p className="text-sm font-medium text-white px-2 text-center mt-2">
          Caria Estates CMS v1.0 ile ilanlarınızı ve sayfalarınızı kolayca yönetin.
        </p>

        <div
          className="mt-4 flex h-full w-full items-center justify-center rounded-xl bg-white/20 py-3 text-sm font-bold text-white transition duration-200"
        >
          Yönetim Paneli
        </div>
      </div>

...
const InvoiceListGlobalSearch = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Col sm={4} xxl={1}>
                <Button color="primary" className="w-100" style={{ paddingInline: 10 }}>
                    <i className="ri-equalizer-fill me-1 align-bottom"></i>{" "}
                    Filters
                </Button>
            </Col>
...
const TicketsListGlobalFilter = () => {
    return (
        <React.Fragment>
            ...
            <Col xxl={1} sm={4}>
                <button type="button" className="btn btn-secondary w-100" style={{ paddingInline: 10 }}> <i className="ri-equalizer-fill me-1 align-bottom"></i>
                    Filters
                </button>
            </Col>
        </React.Fragment>
    ...
    return (
        <React.Fragment>
            <Col xxl={2} sm={4} className="ms-auto">
                <div>
                    <select className="form-control" data-choices data-choices-search-false name="choices-single-default" id="idStatus">
                        <option value="All Time" defaultValue ="all">All Time</option>

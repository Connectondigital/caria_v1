                            ...
                            <Row className="g-0">
                                <Col xxl={8}>
                                    <div className="">
                                        ...
                                        <MarketplaceChart series={chartData} dataColors='["--vz-primary","--vz-secondary", "--vz-light"]' />
                                    </div>
                                </Col>
                                    ...
                                    <div className="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-center">
                                                <img src={"https://img.themesbrand.com/Caria Estates/images/img-2.gif"} className="img-fluid avatar-xs rounded-circle object-fit-cover" alt="" />
                                            ...
                                            <h4 className="ff-secondary fw-bold mt-4"><i className="mdi mdi-ethereum text-primary"></i> 346.12 ETH</h4>
                                            ...
                                            <div className="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    ...
                                                    <h4 className="fs-18 ff-secondary fw-semibold mb-0">342.74 ETH</h4>
                                                </div>

                                                <div>
                                                    <p className="fs-14 text-muted mb-1">Highest Bid</p>
                                                    <h4 className="fs-18 ff-secondary fw-semibold mb-0">346.67 ETH</h4>
                                                </div>
                                            </div>

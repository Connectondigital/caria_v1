...
const JobGrid = () => {
  document.title = "Job Grid | Caria Estates -  Admin & Dashboard Template";
              ...
              <Card className="card-height-100 bg-info bg-job">
                <CardBody className="p-5">
                  <h2 className="lh-base text-white">
                    Caria Estates invites young professionals for an intership!
                  </h2>
                        ...
                        <React.Fragment key={key}>
                          {
                            subItem === "Full Time" ?
                              ...
                              subItem === "Freelance" ?
                                ...
                                :
                                subItem === "Part Time" ?
                                  <span className="badge bg-warning-subtle text-warning">{subItem}</span>
                                  :
                                  subItem === " Private" ?
                                    <span className="badge bg-info-subtle text-info">{subItem}</span>
                                    :

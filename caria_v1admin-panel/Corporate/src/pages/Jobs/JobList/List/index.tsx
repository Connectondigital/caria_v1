...
const JobList = () => {
  document.title = "Job Lists | Caria Estates -  Admin & Dashboard Template";
              ...
              >
                ...
                <CardBody className="card-body">
                  ...
                  <div className="mt-4">
                    ...
                    <div>
                      <AppSummaryChart dataColors='["--vz-secondary", "--vz-primary", "--vz-success"]' />
                    </div>
                  </div>
                  <div className="mt-4">
                    <button type="button" className="btn btn-soft-info w-100">
                      Apply Now
                    </button>
                  </div>
                </CardBody>

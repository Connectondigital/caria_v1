...
const CandidateList = () => {
  document.title = "Candidate List View | Caria Estates -  Admin & Dashboard Template";
  ...
  const currentdata = useMemo(() => iscandidate?.slice(indexOfFirst, indexOfLast), [indexOfFirst, indexOfLast, iscandidate])

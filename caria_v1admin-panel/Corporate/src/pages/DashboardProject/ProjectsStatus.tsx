...
const ProjectsStatus = () => {
    ...
    const selectprojectstatusData = createSelector(
        ...
        (state) => ({
            projectStatusData: state.projectStatusData
        })
    );
        ...
        <React.Fragment>
            <Col xxl={4} lg={6}>
                <Card className="card-height-100">
                    ...
                    <CardBody>
                        <PrjectsStatusCharts series={chartData} dataColors='["--vz-success", "--vz-primary", "--vz-warning", "--vz-secondary"]' />
                        <div className="mt-3">
                            <div className="d-flex justify-content-center align-items-center mb-4">
                                <h2 className="me-3 ff-secondary mb-0">{chartData[0] + chartData[1] + chartData[2] + chartData[3] || 258}</h2>
                                <div>

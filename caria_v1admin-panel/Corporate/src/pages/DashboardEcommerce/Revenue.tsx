    ...
    <React.Fragment>
      <Card>
        <CardHeader className="border-0 align-items-center d-flex">
          <h4 className="card-title mb-0 flex-grow-1">Hasılat</h4>
          ...
          <Row className="g-0 text-center">
            <Col xs={6} sm={3}>
              <div className="p-3 border border-dashed border-start-0">
                ...
                <p className="text-muted mb-0">İlan Talepleri</p>
              </div>
            </Col>
            <Col xs={6} sm={3}>
              <div className="p-3 border border-dashed border-start-0">
                ...
                <p className="text-muted mb-0">Öngörülen Kazanç</p>
              </div>
            </Col>
            <Col xs={6} sm={3}>
              <div className="p-3 border border-dashed border-start-0">
                ...
                <p className="text-muted mb-0">İadeler</p>
              </div>
            </Col>
            <Col xs={6} sm={3}>
              <div className="p-3 border border-dashed border-start-0 border-end-0">
                ...
                <p className="text-muted mb-0">Dönüşüm Oranı</p>
              </div>
            </Col>
          </Row>
        </CardHeader>

...
const UiCards = () => {
    ...
    document.title="Cards | Caria Estates - React Admin & Dashboard Template";
                    ...
                    <Row>
                        ...
                        <Col xxl={4}>
                            <Card className="card-light">
                                ...
                                <div className="card-footer">
                                    <div className="text-center">
                                        <Link to="#" className="text-body">Connect Now <i className="ri-arrow-right-s-line align-middle lh-1"></i></Link>
                                    </div>
                                </div>
                            </Card>
                        </Col>
                        ...
                        <Col xxl={4}>
                            <Card className="border card-border-dark">
                                ...
                                <CardBody>
                                    <p className="card-text">They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link to="#" className="text-body fw-medium">Read More <i className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>

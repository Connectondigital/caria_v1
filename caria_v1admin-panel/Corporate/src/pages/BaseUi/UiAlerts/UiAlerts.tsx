...
const UiAlerts = () => {
    document.title="Alerts | Caria Estates - React Admin & Dashboard Template";
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Col xl={6}>
                                                <h6>Primary Alert</h6>
                                                <UncontrolledAlert color="primary" className="alert-primary alert-dismissible bg-primary text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-user-smile-line label-icon"></i><strong>Primary</strong> -Label icon alert
                                                </UncontrolledAlert>

                                                <h6>Secondary Alert</h6>
                                                <UncontrolledAlert color="secondary" className="alert-secondary alert-dismissible bg-secondary text-white alert-label-icon fade show" closeClassName="btn-close-white" >
                                                ...
                                                <h6>Success Alert</h6>
                                                <UncontrolledAlert color="success" className=" alert-success alert-dismissible bg-success text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                ...
                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger" className=" alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0" closeClassName="btn-close-white">
                                            ...
                                            <Col xl={6}>
                                                <h6>Warning Alert</h6>
                                                <UncontrolledAlert color="warning" className=" alert-warning alert-dismissible bg-warning text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-alert-line label-icon"></i><strong>warning</strong> - Label
                                                    icon alert
                                                </UncontrolledAlert>

                                                <h6>Info Alert</h6>
                                                <UncontrolledAlert color="info" className=" alert-info alert-dismissible bg-info text-white alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-airplay-line label-icon"></i><strong>Info</strong> - Label
                                                    icon alert
                                                </UncontrolledAlert>

                                                <h6>Light Alert</h6>
                                                <UncontrolledAlert color="light" className=" alert-light alert-dismissible bg-light text-body alert-label-icon fade show" closeClassName="btn-close-white">
                                                    <i className="ri-mail-line label-icon"></i><strong>Light</strong> -
                                                    Label icon alert
                                                </UncontrolledAlert>

                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className=" alert-dark alert-dismissible bg-dark text-white alert-label-icon fade show mb-0" closeClassName="btn-close-white">
                                        ...
                                        <Row>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="light" className="alert-top-border">
                                                    <i className="ri-mail-line me-3 align-middle fs-16 text-body"></i><strong>Light</strong>
                                                    - Top border alert
                                                </UncontrolledAlert>

                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="alert-top-border mb-0">
                                                    <i className="ri-refresh-line me-3 align-middle fs-16 text-body"></i><strong>Dark</strong>
                                                    - Top border alert
                                                </UncontrolledAlert>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the class to set an alert with solid style.</p>

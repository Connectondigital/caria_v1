...
import { DefaultButtonsExample, OutlineButtonsExample, RoundedButtonsExample, SoftButtonsExample, GradientButtonsExample, AnimationButtonsExample, LabelButtonsExample, SizeButtonsExample, WidthButtonsExample, TagButtonsExample, GridButtonsExample, CheckButtonsExample, GroupButtonsExample, IconButtonsExample, ToolbarButtonsExample, GroupsizingButtonsExample, VerticalButtonsExample, GhostButtonsExample, LoadingbuttonsExample, BorderButtonsExample, CustomToggleButtonsExample, FocusRingUtilityExample, FocusRingExample, BaseClassExample, CustomSizeExample } from './UiButtonCode';


const UiButtons = () => {
    document.title = "Buttons | Caria Estates - React Admin & Dashboard Template";
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-soft-</code>  class with the below-mentioned variation to create a button with the soft background.</p>                                        <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <button className="btn btn-soft-success"> Success </button>
                                            <button className="btn btn-soft-info"> Info </button>
                                            <button className="btn btn-soft-warning"> Warning </button>
                                            <button className="btn btn-soft-danger"> Danger </button>
                                            <button className="btn btn-soft-dark"> Dark </button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                                            ...
                                            <ButtonGroup>
                                                ...
                                                <label className='btn btn-outline-secondary mb-0' id="btnradio1" htmlFor='btnradio1'>Radio 1</label>

                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
                                                <label className='btn btn-outline-secondary mb-0' id="btnradio2" htmlFor='btnradio2'>Radio 2</label>

                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio3" />
                                                <label className='btn btn-outline-secondary mb-0' id="btnradio3" htmlFor='btnradio3'>Radio 3</label>
                                        ...
                                        <Row>
                                            ...
                                            <div className="col-auto">
                                                <ButtonGroup vertical>
                                                    ...
                                                    <label className='btn btn-outline-secondary' id="vbtn-radio1" htmlFor='vbtn-radio1'>Radio 1</label>
                                                    <Input type="radio" className="btn-check" name="vbtn" id="vbtn-radio2" />
                                                    <label className='btn btn-outline-secondary' id="vbtn-radio2" htmlFor='vbtn-radio2'>Radio 2</label>
                                                    <Input type="radio" className="btn-check" name="vbtn" id="vbtn-radio3" />
                                                    <label className='btn btn-outline-secondary' id="vbtn-radio3" htmlFor='vbtn-radio3'>Radio 3</label>
                                                </ButtonGroup>
                                            </div>
                                        </Row>
                                    </div>

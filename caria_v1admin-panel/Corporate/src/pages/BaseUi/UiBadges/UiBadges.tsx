...
const UiBadges = () => {
    document.title = "Badges | Caria Estates - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent />
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>bg--subtle</code> class with the below-mentioned variation to create a softer badge.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use the <code>rounded-pill bg--subtl</code> class with the below-mentioned variation
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">
                                        Use the <code>badge-border</code> and <code>bg-color-subtle</code> with below mentioned modifier classes to make badges with border & soft backgorund.
                                    </p>
                                    <div className="live-preview">
                                        ...
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <span className="badge bg-light-subtle text-bodybadge-border text-body">Light</span>
                                        </div>
                                    </div>

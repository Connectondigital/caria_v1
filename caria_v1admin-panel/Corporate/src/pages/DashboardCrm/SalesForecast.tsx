...
const SalesForecast = () => {
    ...
    const selectDashboardData = createSelector(
        ...
        (state) => ({
            salesForecastData: state.salesForecastData
        })
    );
                ...
                <Card>
                    <CardHeader className="align-items-center d-flex">
                        ...
                        <div className="flex-shrink-0">
                            <UncontrolledDropdown className="card-header-dropdown">
                                ...
                                <DropdownMenu className="dropdown-menu-start" end>
                    ...
                    <div className="card-body pb-0">
                        <div id="sales-forecast-chart" className="apex-charts">
                            <SalesForecastCharts series={chartData} dataColors='["--vz-primary", "--vz-success", "--vz-secondary"]' />
                        </div>
                    </div>
                </Card>
            </Col>

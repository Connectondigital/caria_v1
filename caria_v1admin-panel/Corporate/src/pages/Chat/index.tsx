...
const Chat = () => {
  ...
  document.title = "Chat | Caria Estates - React Admin & Dashboard Template";
      ...
      <div className="page-content">
        <Container fluid>
          <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        ...
                        >
                          {(chats || []).map(
                            (chatsChannel: chatContactType) =>
                              ...
                              (chatsChannel.channelsList || [])?.map(
                                (channel, key: number) => (
                                  <React.Fragment key={key}>
                                    <li
                                      className={
                                        Chat_Box_Username === channel.name
                                          ? "active"
                                          : ""
                                      }
                                    >
                  ...
                  >
                    {isLoading ? (
                      ...
                      <div className="sort-contact">
                        {(chatContactData || []).map(
                          (contact: chatContactDataTye, key: number) => (
                            <div className="mt-3" key={key}>
                              <div className="contact-list-title">
                                {contact.title}
                              </div>
                              <ul
                                id={"contact-sort-" + contact.title}
            ...
            <div
              className="user-chat w-100 overflow-hidden minimal-border"
              ref={userChatShow}
            >

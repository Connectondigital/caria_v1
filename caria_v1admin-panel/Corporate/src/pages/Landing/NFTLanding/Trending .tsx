                                            ...
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col className='col-6'>
                                                        ...
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-2.gif"} alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col className='col-6'>
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-5.gif"} alt="" className="img-fluid rounded mb-1" />
                                            ...
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col className='col-6'>
                                                        ...
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-1.gif"} alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col className='col-6'>
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-1.gif"} alt="" className="img-fluid rounded mb-1" />
                                            ...
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col className='col-6'>
                                                        ...
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-3.gif"} alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col className='col-6'>
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-1.gif"} alt="" className="img-fluid rounded mb-1" />
                                        ...
                                        <Card>
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col className='col-6'>
                                                        <img src={Img03} alt="" className="img-fluid rounded" />
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-5.gif"} alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col className='col-6'>
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-2.gif"} alt="" className="img-fluid rounded mb-1" />
                                                        <img src={Img05} alt="" className="img-fluid rounded" />
                                                    </Col>
                                                </Row>
                                                <Link to="#" className="float-end"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>

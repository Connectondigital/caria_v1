                ...
                <Row className="justify-content-center">
                    <Col lg={8} sm={10}>
                        <div className="text-center">
                            <h1 className="display-4 fw-medium mb-4 lh-base text-white">Discover Digital Art & Collect <span className="text-secondary">NFT Marketplace</span></h1>
                            ...
                            <div className="hstack gap-2 justify-content-center">
                                ...
                                <Link to="/nft-explore" className="btn btn-secondary">Explore Now <i className="ri-arrow-right-line align-middle ms-1"></i></Link>
                            </div>
                        </div>
                    </Col>
                </Row>

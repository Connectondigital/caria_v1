                                ...
                                <CardBody className="text-center p-4">
                                    <div className="avatar-xl mx-auto mb-4 position-relative">
                                        ...
                                        <Link to="/apps-mailbox"
                                            className="btn btn-secondary btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                            ...
                            <Card>
                                <CardBody className="text-center p-4">
                                    <div className="avatar-xl mx-auto mb-4 position-relative">
                                        ...
                                        <Link to="/apps-mailbox"
                                            className="btn btn-secondary btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-x">
                                            <div className="avatar-title bg-transparent">
                                                <i className="ri-mail-fill align-bottom"></i>
                                            </div>
                                        </Link>

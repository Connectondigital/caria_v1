                        ...
                        <Col lg={8}>
                            <div className="text-center mb-5">
                                ...
                                <div className="hstack gap-2 justify-content-center">
                                    ...
                                    <button type="button" className="btn btn-secondary btn-label rounded-pill"><i className="ri-twitter-line label-icon align-middle rounded-pill fs-16 me-2"></i> Send Us Tweet</button>
                                </div>
                            </div>
                        </Col>
                    </Row>

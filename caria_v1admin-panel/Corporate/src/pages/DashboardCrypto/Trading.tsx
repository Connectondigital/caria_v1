                ...
                <Card>
                    ...
                    <div className="card-body p-0">
                        <TabContent activeTab={activeTab} className="p-0">
                            <TabPane tabId="1">
                                <div className="p-3 bg-success-subtle">
                                    <div className="float-end ms-2">
                                        <h6 className="text-success mb-0">USD Balance : <span className="text-body">$12,426.07</span></h6>
                                    </div>
                                    <h6 className="mb-0 text-success">Buy Coin</h6>
                                </div>
                                <div className="p-3">
                                    <Row>
                                        <Col xs-={6}>
                                    ...
                                    <div className="mt-3 pt-2">
                                        <button type="button" className="btn btn-success w-100">Buy Coin</button>
                                    </div>
                                </div>
                            </TabPane>

                            <TabPane tabId="2">
                                <div className="p-3 bg-danger-subtle">
                                    <div className="float-end ms-2">
                                        <h6 className="text-danger mb-0">USD Balance : <span className="text-body">$12,426.07</span></h6>
                                    </div>

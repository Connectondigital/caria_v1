...
const Offlinepage = () => {
    ...
    document.title = "Offline Page | Caria Estates - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                                ...
                                <Card className="overflow-hidden">
                                    <CardBody className="p-4">
                                        <div className="text-center">
                                            <img src="https://img.themesbrand.com/Caria Estates/images/auth-offline.gif" alt="" height="210" />

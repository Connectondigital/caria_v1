...
const CoverPasswReset = () => {
    document.title = "Reset Password | Caria Estates - React Admin & Dashboard Template";
                                    ...
                                    <Row className="justify-content-center g-0">
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <p className="text-muted">Reset password with Caria Estates</p>
                                                ...
                                                <div className="p-2">
                                                    <Form onSubmit={validation.handleSubmit}>
                                                        ...
                                                        <div className="text-center mt-4">
                                                            <Button color="secondary" className="w-100" type="submit">Send Reset Link</Button>
                                                        </div>
                                                    </Form>
                                                </div>

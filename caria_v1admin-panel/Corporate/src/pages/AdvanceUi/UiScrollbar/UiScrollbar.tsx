...
document.title="Scrollbar | Caria Estates - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                                                    ...
                                                    <Link to="#" className="text-reset notification-item d-block dropdown-item">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1 text-muted">
                                                                <p className="m-0">Your <span className="fw-semibold text-body">Elite</span> author Graphic Optimization <span className="text-secondary">reward</span> is ready!</p>

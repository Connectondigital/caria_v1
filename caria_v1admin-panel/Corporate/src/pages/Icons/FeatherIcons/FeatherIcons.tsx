...
const FeatherIcons = () => {
    document.title="Feather Icons | Caria Estates - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                        ...
                        <Col xs={12}>
                            <Card >
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;FeatherIcon icon="**"/&gt;</code> class.</p>
                                </CardHeader>
                        ...
                        <Col xs={12} >
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;FeatherIcon icon="**"/&gt;</code> class.Available sizes <code>xs, sm,md,lg,xl,xxl</code></p>
                                </CardHeader>
                                <CardBody className="pt-0">
                                    <Row className="icon-demo-content">
                        ...
                        <Col xs={12}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;FeatherIcon icon="**" className="icon-dual-**" /&gt;</code>.</p>
                                </CardHeader>
                                <CardBody className="pt-0">
                                    ...
                                    <Row className="icon-demo-content">
                                        ...
                                        <Col xl={3} lg={4} sm={6} >
                                            <FeatherIcon icon="alert-octagon" className="icon-dual-success" /> alert-octagon
                                        </Col>

                                        <Col xl={3} lg={4} sm={6} >
                                            <FeatherIcon icon="alert-triangle" className="icon-dual-info" /> alert-triangle
                                        </Col>

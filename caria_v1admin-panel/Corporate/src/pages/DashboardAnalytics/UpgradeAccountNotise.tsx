                ...
                <Col xs={12}>
                    <Card>
                        <CardBody className="p-0">
                            <Alert className="border-0 rounded-0 m-0 d-flex align-items-center" role="alert" color='primary'>
                                <FeatherIcon
                                    icon="alert-triangle"
                            ...
                            <Row className="align-items-end">
                                <Col sm={8}>
                                    <div className="p-3">
                                        ...
                                        <div className="mt-3">
                                            <Link to="/pages-pricing" className="btn btn-secondary">Upgrade Account!</Link>
                                        </div>
                                    </div>
                                </Col>
                                <Col sm={4}>

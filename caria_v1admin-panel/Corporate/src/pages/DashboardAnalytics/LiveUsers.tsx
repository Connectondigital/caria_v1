            ...
            <Col xxl={7}>
                <Row className="h-100">
                    <Col xl={6}>
                        <Card className="card-height-100">
                            <div className="card-header align-items-center d-flex">
                                <h4 className="card-title mb-0 flex-grow-1">Ülkeye Göre Canlı Kullanıcılar</h4>
                                ...
                                <div className="table-responsive table-card mt-3">
                                    <table className="table table-borderless table-sm table-centered align-middle table-nowrap mb-1">
                                        <thead className="text-muted border-dashed border border-start-0 border-end-0 bg-light-subtle">
                                            <tr>
                                                <th>Süre (Sn)</th>
                                                <th style={{ width: "30%" }}>Oturumlar</th>
                                                <th style={{ width: "30%" }}>Görüntülemeler</th>
                                            </tr>
                                        </thead>
                    ...
                    <Col xl={6}>
                        <Card className="card-height-100">
                            <div className="card-header align-items-center d-flex">
                                <h4 className="card-title mb-0 flex-grow-1">Ülkelere Göre Oturumlar</h4>

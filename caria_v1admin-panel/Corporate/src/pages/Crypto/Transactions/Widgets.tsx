                ...
                <Card className="card-animate">
                    <CardBody>
                        ...
                        <h4 className="mb-2">
                            ...
                            <small className="text-muted fs-13">.68k</small></h4>
                ...
                <Card className="card-animate">
                    <CardBody>
                        ...
                        <h4 className="mb-2">
                            ...
                            <small className="text-muted fs-13">.22k</small></h4>
                    ...
                    <SwiperSlide>
                        <Card className="card-animate">
                            <div className="card-body bg-warning-subtle">
                                ...
                                <h4 className="mb-2">$245<small className="text-muted fs-13">.65k</small></h4>
                    ...
                    <SwiperSlide>
                        <Card className="card-animate">
                            <div className="card-body bg-warning-subtle">
                                ...
                                <h4 className="mb-2">$24<small className="text-muted fs-13">.74k</small></h4>
                                <h6 className="text-muted mb-0">Send - Receive (Previous Month)</h6>
                            </div>
                        </Card>
                    </SwiperSlide>
                    <SwiperSlide>
                        <Card className="card-animate">
                            <div className="card-body bg-warning-subtle">
                                ...
                                <h4 className="mb-2">$124<small className="text-muted fs-13">.36k</small></h4>
                                <h6 className="text-muted mb-0">Send - Receive (Previous Month)</h6>
                            </div>
                        </Card>
                    </SwiperSlide>

                ...
                <CardBody className="bg-primary-subtle">
                    <div className="d-flex">
                        <div className="flex-grow-1">
                            ...
                            <h4>$61,91,967<small className="text-muted fs-14">.29</small></h4>
                        ...
                        <div className="flex-shrink-0">
                            <i className="mdi mdi-wallet-outline text-primary fs-2"></i>
                        </div>
                    </div>
                </CardBody>
            </Card>
                ...
                <CardBody>
                    <div className="d-flex">
                        <div className="flex-grow-1">
                            ...
                            <h4>$2,74,365<small className="text-muted fs-14">.84</small></h4>
                        ...
                        <div className="flex-shrink-0">
                            <i className="ri-hand-coin-line text-primary fs-2"></i>
                        </div>
                    </div>
                </CardBody>
            </Card>
                ...
                <CardBody>
                    <div className="d-flex">
                        <div className="flex-grow-1">
                            ...
                            <h4>$32,67,120<small className="text-muted fs-14">.42</small></h4>
                        ...
                        <div className="flex-shrink-0">
                            <i className="ri-line-chart-line text-primary fs-2"></i>
                        </div>
                    </div>
                </CardBody>
            </Card>

...
const FileManager = () => {
    document.title = "File Manager | Caria Estates - React Admin & Dashboard Template";
                                                    ...
                                                    <table className="table table-borderless table-nowrap table-sm">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td className="share-path">Caria Estates:\Documents\</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                ...
                <ModalBody>
                    ...
                    >
                        ...
                        {!isEdit && <div className="mb-4">
                            <Row>
                                <Col>
                                    <label htmlFor="files-input" className="form-label">Files</label>
                                    <Input type="text" className="form-control" id="files-input"
                                        name='folderFile'
                                        ...
                                        invalid={folderValidation.touched.folderFile && folderValidation.errors.folderFile ? true : false}
                                    />
                                    {folderValidation.touched.folderFile && folderValidation.errors.folderFile ? (
                                        <FormFeedback type="invalid">{folderValidation.errors.folderFile}</FormFeedback>
                                    ) : null}
                                </Col>
                                <Col>
                                    <label htmlFor="size-input" className="form-label">Size</label>
                                    <Input type="text" className="form-control" id="size-input"
                                        name='size'
                                        ...
                                        invalid={folderValidation.touched.size && folderValidation.errors.size ? true : false}
                                    />
                                    {folderValidation.touched.size && folderValidation.errors.size ? (
                                        <FormFeedback type="invalid">{folderValidation.errors.size}</FormFeedback>
                                    ) : null}
                                </Col>
                            </Row>
                        </div>}

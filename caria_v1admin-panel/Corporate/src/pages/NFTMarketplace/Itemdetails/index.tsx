...
const ItemDetails = () => {
    document.title = "Item Details | Caria Estates - React Admin & Dashboard Template";
                            ...
                            <Row className="g-4">
                                        ...
                                        <Card className="ribbon-box border shadow-none right">
                                            ...
                                            <div className="position-absolute bottom-0 p-3">
                                                ...
                                                <Row className="justify-content-center">
                                                    ...
                                                    <Col className="col-3">
                                                        <img src={"https://img.themesbrand.com/Caria Estates/images/img-3.gif"} alt="" className="img-fluid rounded h-100 object-fit-cover" />
                                                    </Col>
                                                    <Col className="col-3">
                                ...
                                <Col lg={8}>
                                    <div>
                                        ...
                                        <span className="badge bg-secondary-subtle text-secondary mb-3 fs-12"><i className="ri-eye-line me-1 align-bottom"></i> 8,634 people views this</span>
                                                        ...
                                                        <table className="table align-middle table-nowrap mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="text-body"><span className="mb-0 ms-2">Brave Tigers NFT</span></Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>0.235 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="text-body"><span className="mb-0 ms-2">Creative filtered portrait</span></Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>571.24 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            <img src={"https://img.themesbrand.com/Caria Estates/images/img-4.gif"} alt="" className="avatar-xs rounded object-fit-cover" />
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="text-body"><span className="mb-0 ms-2">Robotic Body Art</span></Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>81.72 ETH</td>
                                                                    <td>

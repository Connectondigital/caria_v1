...
const Collections = () => {
    document.title = "Collections | Caria Estates - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                        ...
                        {topCollection.map((item, key) => (<Col xl={3} md={4} sm={6} key={key}>
                            <Card>
                                <CardBody>
                                    ...
                                    <h5 className="mb-0 fs-16"><Link to="#" className="text-reset">{item.category} <span className="badge bg-success-subtle text-success">{item.quantity}</span></Link></h5>
                                </CardBody>
                            </Card>
                        </Col>))}
                    </Row>

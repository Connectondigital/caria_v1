...
const ExploreNow = () => {
    document.title = "Explore Now | Caria Estates - React Admin & Dashboard Template";
                                        ...
                                        <Row className="row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1 mt-3 g-3">
                                            ...
                                            <Col>
                                                ...
                                                <select
                                                    ...
                                                    id="select-category"
                                                    onChange={(e:any) => category(e.target.value)}
                                                >
                                            ...
                                            <Col>
                                                ...
                                                <select
                                                    ...
                                                    data-choices-search-false
                                                    id="file-type"
                                                    onChange={(e:any) => fileType(e.target.value)}
                                                >
                                            ...
                                            <Col>
                                                ...
                                                <select
                                                    ...
                                                    data-choices-search-false
                                                    id="all-sales-type"
                                                    onChange={(e:any) => salesType(e.target.value)}
                                                >
                            ...
                            <Card className="explore-box card-animate">
                                ...
                                <div className="bookmark-icon position-absolute top-0 end-0 p-2">
                                    ...
                                    <button
                                        ...
                                        aria-pressed="true"
                                        onClick={(e:any) => favouriteBtn(e.target)}
                                    >

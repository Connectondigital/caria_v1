...
const Creators = () => {
    document.title = "Creators | Caria Estates - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                ...
                <Container fluid>
                    ...
                    <Row className="g-4 mb-3">
                        <Col className="col-sm-auto">
                            <div>
                                <Link to="/apps-projects-create" className="btn btn-secondary"><i className="ri-add-line align-bottom me-1"></i> Add New</Link>
                            </div>
                        </Col>
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <button className={item.isFollowBtn ? "btn btn-primary w-100" : "btn btn-soft-primary w-100"}>{item.isFollowBtn ? "Follow" : "UnFollow"} </button>
                                    </div>
                                </Card>
                            </Col>
                        ))}

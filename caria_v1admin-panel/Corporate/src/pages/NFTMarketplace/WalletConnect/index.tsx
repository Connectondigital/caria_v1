...
const WalletConnect = () => {
    document.title = "Wallet Connect | Caria Estates - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                        ...
                        <Col lg={3}>
                            <Card className="text-center">
                                <CardBody className="py-5 px-4">
                                    ...
                                    <Link to="#" className="btn btn-secondary">Change Wallet</Link>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                            ...
                            <Col key={key} lg={3}>
                                <Card className="text-center">
                                    <CardBody className="py-5 px-4">
                                        ...
                                        <Link to="#" className="btn btn-soft-primary">Connect Wallet</Link>
                                    </CardBody>
                                </Card>
                            </Col>
                        ))}

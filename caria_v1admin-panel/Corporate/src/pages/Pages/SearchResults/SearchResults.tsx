...
document.title="Search Results | Caria Estates - React Admin & Dashboard Template";
                            ...
                            <Card>
                                ...
                                <CardBody className="p-4">
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            <div className="pb-3">
                                                <h5 className="mb-1"><Link to="#">Caria Estates - Responsive Bootstrap 5 Admin Dashboard</Link></h5>
                                                <p className="text-success mb-2">https://themesbrand.com/Caria Estates/index.html</p>
                                                <p className="text-muted mb-2">Caria Estates admin is super flexible, powerful, clean, modern & responsive admin template based on <span className="fw-semibold">bootstrap 5</span> stable with unlimited possibilities. You can simply change to any layout or mode by changing a couple of lines of code. You can start small and large projects or update design in your existing project using Caria Estates it is very quick and easy as it is beautiful, adroit, and delivers the ultimate user experience.</p>

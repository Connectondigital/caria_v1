...
const SiteMap = () => {
    document.title="SiteMap | Caria Estates - React Admin & Dashboard Template";
    return (
        <div>
                                            ...
                                            <ul className="administration">
                                                <li>
                                                    <ul className="director">
                                                        <li>
                                                            <Link to="#"
                                                                className="fw-semibold"><span>Caria Estates Admin</span></Link>
                                                                ...
                                                                <li className="department">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li><Link to="#"><span>Payment
                                                                            Option</span></Link></li>
                                                                        <li><Link
                                                                            to="#"><span>Confirmation</span></Link>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li className="department">
                                        ...
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="mb-0 list-unstyled">
                                                    <li className="p-0 parent-title"><Link to="#" className="fw-medium fs-14">Caria Estates</Link></li>
                                                    <li>
                                                        <div className="first-list">
                                                            <div className="list-wrap">

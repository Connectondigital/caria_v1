...
const Timeline = () => {
    ...
    document.title = "Timeline | Caria Estates - React Admin & Dashboard Template";
                                ...
                                <div className="timeline">
                                        ...
                                        <div className="content">
                                            ...
                                            <Row className="g-2">
                                                ...
                                                <Col sm={6}>
                                                    <div className="d-flex border border-dashed p-2 rounded position-relative">
                                                        <div className="flex-shrink-0 avatar-xs">
                                                            <div className="avatar-title bg-info-subtle text-info fs-15 rounded">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">Every team project can have a Caria Estates. Use the Caria Estates to share information with your team to understand and contribute to your project.</p>
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            <h5>Caria Estates admin dashboard templates layout upload</h5>
                                    ...
                                    <div className="timeline-continue">
                                        ...
                                        <Row className="timeline-right">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box">
                                                    <div className="timeline-text">
                                                        <h5>Caria Estates - Project Discussion</h5>

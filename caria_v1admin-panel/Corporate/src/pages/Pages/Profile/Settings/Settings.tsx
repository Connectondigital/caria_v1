...
const Settings = () => {
    ...
    document.title = "Profile Settings | Caria Estates - React Admin & Dashboard Template";
                                ...
                                <CardBody>
                                    ...
                                    <div className="mb-3 d-flex">
                                        ...
                                        <Input type="text" className="form-control" id="websiteInput"
                                            placeholder="www.example.com" defaultValue="www.Caria Estates.com" />
                                    </div>
                                    <div className="mb-3 d-flex">
                                        <div className="avatar-xs d-block flex-shrink-0 me-3">
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="email" className="form-control" id="emailInput"
                                                                ...
                                                                defaultValue="daveadame@Caria Estates.com" />
                                                        </div>
                                                    </Col>
                                                    <Col lg={12}>
                                                        <div className="mb-3">

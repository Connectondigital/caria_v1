...
const SimplePage = () => {
    ...
    document.title = "Profile | Caria Estates - React Admin & Dashboard Template";
                            ...
                            <div>
                                <div className="d-flex profile-wrapper">
                                    ...
                                    <div className="flex-shrink-0">
                                        <Link to="/pages-profile-settings" className="btn btn-secondary"><i
                                                            ...
                                                            <Table className="table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="text-muted">daveadame@Caria Estates.com</td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#" className="fw-semibold">www.Caria Estates.com</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                                                    ...
                                                                                    <UncontrolledCollapse toggler="collapseFive" defaultOpen>
                                                                                        <div
                                                                                            ...
                                                                                            <p className="text-muted mb-2">
                                                                                                ...
                                                                                                have a Caria Estates. Use the
                                                                                                Caria Estates to share
                                                ...
                                                <div className="acitivity-timeline">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">added a new member to Caria Estates
                                                                dashboard</p>

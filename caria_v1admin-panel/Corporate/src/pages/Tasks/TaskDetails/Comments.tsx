                            ...
                            <SimpleBar style={{ height: "508px" }} className="px-3 mx-n3 mb-2">
                                <div className="d-flex mb-4">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h5 className="fs-14 text-body"><Link to="/pages-profile" className='text-reset'>Joseph Parker</Link> <small className="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                        ...
                                        <div className="d-flex mt-4">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <h5 className="fs-14 text-body"><Link to="/pages-profile" className='text-reset'>Tonya Noble</Link> <small className="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                                ...
                                <div className="d-flex mb-4">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h5 className="fs-14 text-body"><Link to="/pages-profile" className='text-reset'>Thomas Taylor</Link> <small className="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h5 className="fs-14 text-body"><Link to="/pages-profile" className='text-reset'>Tonya Noble</Link> <small className="text-muted">26 min ago</small></h5>
                                        ...
                                        <div className="d-flex mt-4">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <h5 className="fs-14 text-body"><Link to="/pages-profile" className='text-reset'>Nancy Martino</Link> <small className="text-muted">8 sec ago</small></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-15 mb-0"><Link to="#">Caria Estates admin.ppt</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PPT File</td>
                                            ...
                                            <th scope="row">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-2">
                                                        <Link to="/pages-profile" className="fw-medium text-reset">Thomas Taylor</Link>
                                                    </div>
                                                </div>
                                            </th>
                                            <td>02 Jan, 2022</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-2">
                                                        <Link to="/pages-profile" className="fw-medium text-reset">Tonya Noble</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>28 Dec, 2021</td>

...
const InvoiceDetails = () => {
  ...
  document.title = "Invoice Details | Caria Estates - React Admin & Dashboard Template";
                    ...
                    <div className="d-flex">
                      ...
                      <div className="flex-shrink-0 mt-sm-0 mt-3">
                        ...
                        <h6>
                          ...
                          <span id="email">Caria Estates@themesbrand.com</span>
                        </h6>
                        <h6>
                    ...
                    <div className="border-top border-top-dashed mt-2">
                      <Table className="table table-borderless table-nowrap align-middle mb-0 ms-auto" style={{ width: "250px" }}>
                        <tbody>
                          ...
                          <tr>
                            <td>Discount <small className="text-muted">(Caria Estates15)</small></td>

...
import { registerUser, 
    // apiError, 
    resetRegisterFlag } from "../../slices/thunks";
...
const Register = () => {
    ...
    document.title = "Basic SignUp | Caria Estates - React Admin & Dashboard Template";
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Caria Estates
